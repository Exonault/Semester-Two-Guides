...
\begin{gather*}
\iint\limits_{x^2+y^2 < 1} \cos (\pi \sqrt{x^2 + y^2}) \, dx \, dy = \iint\limits_{G} \rho \cos(\pi \rho) \, d\rho \, d \varphi = \int\limits_{-\pi} ^{\pi} d\varphi \int\limits_0 ^1 \rho \cos(\pi \rho) \, d\rho = - \frac{4}{\pi}
\end{gather*}
\end{example}
