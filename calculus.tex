...
Нека $f: D \rightarrow \mathbb{R}, a \in \mathbb{R}^m$, а е точка на сгъстяване за D. Казва се че $f(x)$ има граница L при $x \rightarrow a$ със стойностти $x \neq a$ ако за всяко $\varepsilon > 0$ съществува $\delta > 0$, че за всяко x от множеството $D \setminus \{a\}$, за което $\rho(x;a) = \Vert x - a \Vert < \delta $ е изпълнено $\vert f(x) - L \vert  < \varepsilon$. Записва се $$\lim\limits_{x \rightarrow a} f(x) = L$$
\end{definition}
...
\begin{enumerate}
		\item  Съществува такава околност $U_{a_2} \subset \mathbb{R}$ на точката $a_2$, че за всички стойностти $y \in U_{a_2} $ да съществува  $\lim\limits_{x \rightarrow a_1} f(x,y) = \varphi (y)$.
...
Казва се, че функцията $f: D \rightarrow \mathbb{R}$ е непрекъсната в точка $a \in D$, ако за всяко $\varepsilon > 0$ съществува $\delta > 0$, че за всяко x от множеството $D $, за което $\rho(x;a) = \Vert x - a \Vert < \delta $ е изпълнено $\vert f(x) - f(a) \vert  < \varepsilon$.
\end{definition}
...
\begin{definition}
Нека $A \subset \mathbb{R}^m$ е отворено множество и $f: A \rightarrow \mathbb{R}$. Функцията се нарича равномерно непрекъсната в A, ако за  всяко $\varepsilon > 0$ съществува $\delta = \delta(\epsilon)$, че за всеки две точки $x', x'' \in A$ за които разстоянието $\rho(x';x'') =\Vert x' - x'' \Vert < \delta $, да следва, че $\vert f(x') - f(x'') \vert  < \varepsilon$.
\end{definition}
...
\item $\lim\limits_{n \rightarrow \infty} \dfrac{1}{n} = 0, \, \dfrac{\vert \sin{n} \vert}{n} \in \left[0, \dfrac{1}{n} \right] \implies 
\lim\limits_{n \rightarrow \infty} x_n = 1, \, \lim\limits_{n \rightarrow \infty} y_n = 2 \implies 
\text{редицата е сходяща; точката (1,2) е нейна граница}$

\item $ \lim\limits_{n \rightarrow \infty} x_n = e , \lim\limits_{n \rightarrow \infty} y_n = \infty \implies 
\text{разходяща редица} $

\item $ \lim\limits_{n \rightarrow \infty} x_n \text{не съществува, защото има две точки на сгъстяване.}, \,  
\lim\limits_{n \rightarrow \infty} y_n = \infty \implies \text{разходяща редица}$

\item $\lim\limits_{n \rightarrow \infty} x_n \text{не съществува, защото има две точки на сгъстяване.}, \,  
\lim\limits_{n \rightarrow \infty} y_n = 0 \implies \text{разходяща редица}$

\item $\lim\limits_{n \rightarrow \infty} x_n \text{не съществува}, \,  
\lim\limits_{n \rightarrow \infty} y_n = \infty \implies \text{разходяща редица}$
...
$$
A = \lim\limits_{(x,y) \rightarrow (0,0)} f(x,y) \quad
A_{1,2} = \lim\limits_{y \rightarrow 0} \left( \lim\limits_{x \rightarrow 0} f(x,y) \right) \quad
A_{2,1} = \lim\limits_{x \rightarrow 0} \left( \lim\limits_{y \rightarrow 0} f(x,y) \right) \quad
$$
...
\item $
f(x,y) = \dfrac{x-y}{x+y} \\
\lim\limits_{x \rightarrow 0} f(x,y) = \dfrac{-y}{y} = -1 \qquad 
\lim\limits_{y \rightarrow 0} f(x,y) = \dfrac{x}{x} = 1 \\
A_{1,2} = \lim\limits_{y \rightarrow 0} \left( \lim\limits_{x \rightarrow 0} f(x,y) \right) = \lim\limits_{y \rightarrow 0} \left( -1 \right) = -1\\
A_{2,1} = \lim\limits_{x \rightarrow 0} \left( \lim\limits_{y \rightarrow 0} f(x,y) \right) = \lim\limits_{x \rightarrow 0} \left( 1 \right) = 1 \\
A = \lim\limits_{(x,y) \rightarrow (0,0)} f(x,y) \text{ Не съществува, защото трябва }A_{1,2} = A_{2,1}
$

\item $
f(x,y) = \dfrac{x^2 + y^2}{x^2y^2 + (x - y)^2}\\
\lim\limits_{x \rightarrow 0} f(x,y) = \dfrac{y^2}{(-y)^2} = 1 \qquad 
\lim\limits_{y \rightarrow 0} f(x,y) = \dfrac{x^2}{x^2} = 1 \\
\implies A_{1,2} = A_{2,1} = 1 \implies \exists A = \lim\limits_{(x,y) \rightarrow (0,0)} f(x,y)\\
\text{Редица: }(x_n, y_n) = (\dfrac{1}{n},\dfrac{1}{n}) \rightarrow (0,0), f(x_n, y_n) = 1 \rightarrow 1\\
\text{Редица: }(x'_n, y'_n) = (\dfrac{1}{n},\dfrac{-1}{n})  \rightarrow (0,0), f(x'_n, y'_n) = \dfrac{2n^2}{1 + 4n^2} \rightarrow \dfrac{1}{2} \neq 1 \\
\implies f(x,y) \text{ няма граница при } (x,y) \rightarrow (0,0)
$

\item $
f(x,y) = \dfrac{xy^2}{x^2+y^4}\\
\lim\limits_{x \rightarrow 0} f(x,y) = \dfrac{0}{y^4} = 0 \qquad 
\lim\limits_{y \rightarrow 0} f(x,y) = \dfrac{0}{x^2} = 0 \\
A_{1,2} = A_{2,1} = 0 \implies \exists A = \lim\limits_{(x,y) \rightarrow (0,0)} f(x,y) \\
\text{Редица: }(x_n, y_n) = (\dfrac{1}{n^2},\dfrac{1}{n}) \rightarrow (0,0), f(x_n, y_n) = \dfrac{1}{2} \rightarrow \dfrac{1}{2} \neq 0\\
\implies f(x,y) \text{ няма граница при } (x,y) \rightarrow (0,0)
$

\item $
f(x,y) = (x+y) \sin{\dfrac{1}{x}} \cos{\dfrac{1}{y}}\\
0 \leq \vert f(x,y) \vert \leq \vert x + y \vert \leq  \vert x \vert + \vert y \vert \text{ и } \vert x \vert + \vert y \vert \rightarrow 0 \\
A = 0 \\
\lim\limits_{x \rightarrow 0} \sin{\dfrac{1}{x}} \text{ - не съществува} \\
\lim\limits_{x \rightarrow 0} f(x,y) = y\cos{\dfrac{1}{y}} \lim\limits_{x \rightarrow 0} \sin{\dfrac{1}{x}}\\$
Аналогично и другата вътрешна граница не съществува. Но тогава и повторните граници $A_{1,2},\, A_{2,1}$ не съществуват. 

\item $f(x,y) = \dfrac{x^4 + y^4}{x^2 + y^2}\\
\lim\limits_{x \rightarrow 0} f(x,y) = y^2 \qquad 
\lim\limits_{y \rightarrow 0} f(x,y) = x^2 \\
A_{1,2} = \lim\limits_{y \rightarrow 0} \left( \lim\limits_{x \rightarrow 0} f(x,y) \right) = \lim\limits_{y \rightarrow 0} \left( y^2 \right) = 0\\
A_{2,1} = \lim\limits_{x \rightarrow 0} \left( \lim\limits_{y \rightarrow 0} f(x,y) \right) = \lim\limits_{x \rightarrow 0} \left( x^2 \right) = 0 \\
...
D = A \cup B \cup C
$ \\
и функцията $f: D \rightarrow \mathbb{R} $ зададена по следния начин \\
$f(x,y) = 
\begin{cases}
...
\lim\limits_{n \rightarrow \infty} R = (x_0, y_0)\\
\lim\limits_{n \rightarrow \infty} f(x_n,y_n) = \dfrac{1}{y_0 ^2} = \dfrac{1}{x_0 ^2} \neq 0\\
\text{Ако } x_0 \neq 0, \ f(x_0,y_0) = 0 \\
\implies \text{ функцията е прекъсната в точката } (x_0, x_0) \neq (0,0) \\
\text{Ако } (x_n , y_n) \in B,\ \lim\limits_{n \rightarrow \infty} f(x_n,y_n) = - \dfrac{1}{x_0 ^2} \neq f(x_0, x_0) \neq 0. \\
\text{Ако } x_0 = 0,\ \lim\limits_{n \rightarrow \infty} f(x_n,y_n) = \infty(-\infty),\ f(0,0) = 0,\\
...
\lim\limits_{h \rightarrow 0} \dfrac{f(0+h,0) - f(0,0)}{h} = \lim\limits_{h \rightarrow 0} \dfrac{\vert h \vert}{h} \text{ не съществува} \\
...
\lim\limits_{h \rightarrow 0} \dfrac{f(0+h,0) - f(0,0)}{h} = \lim\limits_{h \rightarrow 0} \dfrac{0-0}{h} = \lim\limits_{h \rightarrow 0} = 0 \\
\lim\limits_{k \rightarrow 0} \dfrac{f(0,0+k) - f(0,0)}{k} =  \lim\limits_{k \rightarrow 0} \dfrac{0-0}{k} = \lim\limits_{k \rightarrow 0} = 0 \\
...
Решение: \\
$
f'_x (a,b) = \lim\limits_{h \rightarrow 0} \dfrac{f(a +h,b) - f(a,b)}{h} \text{(Ако съществува)} \implies \\
f'_x(x,1) =  \lim\limits_{h \rightarrow 0} \dfrac{f(x +h,1) - f(x,1)}{h} \text{(Ако съществува)}\\
...
\lim\limits_{h \rightarrow 0} \dfrac{f(x +h,1) - f(x,1)}{h} =  \lim\limits_{h \rightarrow 0} \dfrac{x + h - x}{h} = \lim\limits_{h \rightarrow 0} \dfrac{h}{h} =  \lim\limits_{h \rightarrow 0} 1 \implies f'_x(x,1) = 1
$
\end{task}
...
f(x_n, y_n) = \dfrac{ \left( \dfrac{1}{n} \right)^3 \cdot \dfrac{1}{n^3}}{\left( \dfrac{1}{n}\right)^6 + \left( \dfrac{1}{n^3} \right)^3 } = \dfrac{\dfrac{1}{n^6}}{\dfrac{2}{n^6}} = \dfrac{1}{2} \qquad \lim\limits_{n \rightarrow \infty} f(x_n, y_n) = \dfrac{1}{2}  \implies \\
\lim\limits_{x \rightarrow 0, y \rightarrow 0 } f(x, y) \neq f(0,0) = 0 \implies f(x, y) \text{ е прекъсната в т. }(0,0).\\
\\
f'_x (0,0) = \lim\limits_{x \rightarrow 0} \dfrac{f(x,0) - f(0,0)}{x - 0} = \dfrac{ \dfrac{x^3 \cdot 0}{x^6 + 0} - 0}{x - 0} = 0 \\
f'_y (0,0) = \lim\limits_{y \rightarrow 0} \dfrac{f(0,y) - f(0,0)}{y - 0} = \dfrac{\dfrac{0^3 \cdot y}{0^6 + y^2} - 0}{y - 0} = 0
$
\end{task}
